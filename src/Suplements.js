...
const Suplements = () => {
  ...
  const targetRef=useRef(null)
    ...
    return ( 
        <div id='supplements' className="Suplements flex flex-col  container mx-auto px-12">
          <div className="flex  flex-col items-center md:items-stretch gap-4">
           ...
           <svg
            ...
            <h3 style={{color:"#111211"}} className="font-extrabold text-xl">Supplements</h3>
            <div className="text-diet w-full md:w-1/2">
            <p style={{color:"#111211"}} className="font-normal mb-2 text-center md:text-left"> Supplements are some needed for faster achivements and faster results in your progress , those are categorised like for performance for weight loss and for mass gain</p>
            </div>
           </div>
