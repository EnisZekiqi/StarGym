        ...
        >
          <NavbarGeneral/>
            {VaporxInfo.map ((vaporx,index)=>(
                ...
                <p className="text-lg font-medium w-full md:w-fit text-center md:text-start px-4">{vaporx.description}</p>
                <p className="text-md font-normal w-full md:w-1/2 text-center md:text-start  px-4">{vaporx.info}</p>
