...
const NavbarGeneralPlanprogram = () => {
 ...
 <div>
      <div
        ...
        >
         ...
         >
            <div className="fonkJr flex gap-6 items-center">
              ...
              <div onClick={()=>setSuppPlanprogram(true)}>
              <MenuIcon/>
            </div>
            </div>
        ...
        {suppPlanprogram && 
        <div
        className={`fixed inset-0 opacity-50 drawer-backdrop ${suppPlanprogram ? 'open' : ''} ${bg2}`}
        style={{zIndex:200}}
        onClick={()=>setSuppPlanprogram(false)}
      />
        }
...
export default NavbarGeneralPlanprogram;